...
import com.example.crmfood.models.Categories;
...
import com.example.crmfood.models.PodMenu;
...
public interface MyService {
    ...
    Call<List<SubMenu>> getSubMenu(@Header("Authorization") String authToken, @Body long id);
